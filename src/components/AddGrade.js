...
export default function AddGrade() {
    ...
    <div className="border border-success border-5 my-5 p-5 w-50 rounded">
      <div className="container d-flex flex-column">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="row mb-3">
            <label htmlFor="maxSectionSize" className="col-sm-3 col-form-label">
              Section Size
            </label>
            <div className="col-sm-7">
              <input
          ...
          <div className="row mb-3">
            <label htmlFor="admissionFees" className="col-sm-3 col-form-label">
              Admission Fees
            </label>
            <div className="col-sm-7">
              <input
          ...
          <div className="row mb-3">
            <label htmlFor="furnitureFees" className="col-sm-3 col-form-label">
              Furniture Fees
            </label>
            <div className="col-sm-7">
              <input
  ...
  return <Base title="Grade Creation">{createGradeForm()}</Base>;
}
